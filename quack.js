...
;(function (global, factory) {
  ...
  // --- Default CSS ---
  const CSS = `
.quack-container { position: fixed; right: 16px; top: 16px; z-index: 9999; display:flex; flex-direction:column; gap:8px; width:320px; }
.quack-toast { background:#0f172a;color:#e6eef8;padding:12px;border-radius:12px; box-shadow:0 6px 18px rgba(2,6,23,0.5); display:flex; gap:10px; align-items:flex-start; font-family:Inter, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; }
.quack-toast .quack-title { font-weight:600; margin-bottom:4px; }
.quack-toast .quack-body { font-size:13px; opacity:0.95 }
.quack-toast .quack-actions { margin-left:auto; display:flex; gap:6px }
.quack-btn { padding:6px 8px; border-radius:8px; background:transparent; color:inherit; border:1px solid rgba(255,255,255,0.06); cursor:pointer }
.quack-muted { opacity:0.8; font-size:12px }
`;
